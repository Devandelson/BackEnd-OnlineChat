...
export const getItemChat = (nameChat) => {
    return new Promise((resolve, reject) => {
        ...
        conex.execute(query, [nameChat]).then((result) => {
            resolve(result[0]);
        }).catch((error) => {
            reject(error);
        })
...
export const editChat = (body) => {
    return new Promise((resolve, reject) => {
        ...
        conex.execute(query, [arrayConversation, nombre_chat]).then((result) => {
            resolve(result[0]);
        }).catch((error) => {
            reject(error);
        });
...
export const createChat = (nombre_chat) => {
    return new Promise((resolve, reject) => {
        ...
        conex.execute(query, [nombre_chat, JSON.stringify([])]).then((result) => {
            resolve(result[0]);
        }).catch((error) => {
            reject(error);
        });
...
export const deleteChat = (nombre_chat) => {
    return new Promise((resolve, reject) => {
        ...
        conex.execute(query, [nombre_chat]).then((result) => {
            resolve(result[0]);
        }).catch((error) => {
            reject(error);
        });
